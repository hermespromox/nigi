...
assert.match(page, /theme-grid/, 'Customer themes must use readable individual cards rather than one long sentence')
...
assert.match(route, /effort:\s*'medium'/, 'GPT-5.4 Mini must use medium reasoning effort')
